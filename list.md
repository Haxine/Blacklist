...
- 北京中电兴发科技有限公司成都研发基-成都市金牛区蓝海天地大学生创业园|坑爹事迹：临近试用期结束解除劳动合同|详细经历：通过内推进入面试，面试简历已体现本人与公司战略方向（公安）不符合，且面试时沟通的为民用市场产品智能家居方向。入职后知晓试用期6个月，入职培训通过，成绩排名9/20。前面两个月主要是个人学习和参与个别项目支撑工作，从第三个月开始负责运维产品，协同其他同事完成迭代一项目验收和迭代二需求确认，并实质性推动迭代二完成开发，以及完成迭代三的需求规划（需求待项目确认，因转公安项目）。入职第5个月中到临近转正，因公司项目需要被要求投入公安项目，参与案件研判需求分析和原型设计，以及出差客户现场需求沟通。出差回来后即被告知公司要与我解除劳动合同。入职以来，公司从未明确讲述或培训过考核目标，也从未正式询问过我是否愿意转到公安产品线。强烈DISS“伪君子”文化。
